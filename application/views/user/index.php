    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <a href="<?=base_url()?>user/tambah" class="btn btn-outline-success mb-1 float-right"><i class="fas fa-plus"></i> Tambah</a>
                    <br><br><br>
                    <table class="table table-bordered table-striped table-hover dataTables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="<?=base_url()?>user/edit/<?=$row_data->id_user?>" class="btn btn-outline-info btn-sm mb-1 " onclick="return confirm('Apakah anda yakin akan mengedit data ini?');"><i class="fas fa-edit"></i> Edit</a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
